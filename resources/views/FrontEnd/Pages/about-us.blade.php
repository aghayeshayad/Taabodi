...
@section('meta_description')
    <meta name="description" content="@isset($about->meta_description)@endisset">
@endsection
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb justify-content-md-end">
                        <li class="breadcrumb-item"><a href="about.html#">خانه</a></li>
                        <li class="breadcrumb-item"><a href="about.html#">صفحات</a></li>
                            ...
                            <div class="team_box team_style1">
                                <div class="team_img">
                                    ...
                                    <ul class="social_icons social_style1">
                                        <li><a href="about.html#"><i class="ion-social-facebook"></i></a></li>
                                        <li><a href="about.html#"><i class="ion-social-twitter"></i></a></li>
                                        <li><a href="about.html#"><i class="ion-social-googleplus"></i></a></li>
                                        <li><a href="about.html#"><i class="ion-social-instagram-outline"></i></a></li>
                                    </ul>
                                </div>
                                <div class="team_content">
                                    <div class="team_title">
                                        <h5>سعید شمس</h5>
                                        <span>مهندس پروژه</span>
                                    </div>
                                </div>
                            </div>
                        </div>
